	...
	public static function features() {
		return array(
			'page-effects' => array(
				...
				'description' => '樱花、雪花、粒子、灯笼、背景音乐、右键菜单与自定义代码。',
			...
			'ai-summary' => array(
				...
				'description' => '多服务商模型、摘要生成、缓存、动画与文章编辑器快捷管理。',
			...
			'preloader' => array(
				...
				'description' => '多种开屏效果、自定义 Logo、加载完成联动与超时保护。',
			...
			'media-urls' => array(
				...
				'description' => '相对媒体地址、多域名访问、反向代理诊断、扫描预览与安全修复。',
