<?php
/**
 * Template name: Zibll-资源下载（VIP资源中心版）
 * Description: 九流网络定制独立下载页（真实动态数据、深色模式自适应、横竖封面智能适配） - VIP资源中心版 v4
 *
 * 使用说明：
...
.jld-vip{--vip-gold:#efbf62;--vip-gold-deep:#c88a2c;--vip-navy:#101827;--vip-card:#182337;background:linear-gradient(180deg,#0f1724,#141f31 45%,#101826);color:#f4f1e8}
.jld-vip .jld-hero{background:radial-gradient(circle at 82% 18%,rgba(239,191,98,.17),transparent 28%),radial-gradient(circle at 15% 85%,rgba(57,101,160,.25),transparent 32%),linear-gradient(135deg,#0b111d,#152238 58%,#1c2636)}
.jld-vip .jld-decoration-one{width:310px;height:310px;right:-125px;bottom:-165px;border:1px solid rgba(239,191,98,.22);box-shadow:0 0 80px rgba(239,191,98,.12) inset}
.jld-vip .jld-decoration-two{width:180px;height:180px;left:-90px;top:-90px;background:rgba(61,116,179,.12);box-shadow:0 0 70px rgba(65,122,184,.18)}
.jld-vip .jld-breadcrumb,.jld-vip .jld-breadcrumb a{color:rgba(244,241,232,.58)}.jld-vip .jld-breadcrumb a:hover{color:#efbf62}
.jld-vip .jld-cover{border:1px solid rgba(239,191,98,.24);background:linear-gradient(145deg,#1d2d46,#5a4122);box-shadow:0 25px 58px rgba(0,0,0,.35)}
.jld-vip .jld-cover:after{background:linear-gradient(145deg,rgba(12,19,31,.06),rgba(7,11,19,.83))}
.jld-vip .jld-cover-label{color:#1b1a17;background:linear-gradient(135deg,#f9d88f,#dca34a);border:1px solid rgba(255,255,255,.28)}
.jld-vip .jld-cover-mark{color:#f7d996;background:rgba(11,16,26,.7);border:1px solid rgba(239,191,98,.24);box-shadow:0 15px 30px rgba(0,0,0,.28)}
.jld-vip .jld-eyebrow{color:#efbf62}.jld-vip .jld-eyebrow span{background:linear-gradient(90deg,#efbf62,transparent)}
.jld-vip .jld-hero-copy h1{color:#fff}.jld-vip .jld-hero-copy>p{color:rgba(244,241,232,.65)}
.jld-vip .jld-meta-list span{color:#e8dfcd;background:rgba(255,255,255,.045);border:1px solid rgba(239,191,98,.13)}
.jld-vip .jld-button-primary{color:#18140d;background:linear-gradient(135deg,#f8dc9d,#d99d3f);box-shadow:0 14px 28px rgba(190,132,39,.22)}
.jld-vip .jld-button-ghost{color:#f1d79f;background:rgba(255,255,255,.035);border-color:rgba(239,191,98,.25)}
.jld-vip .jld-status-card{background:linear-gradient(145deg,rgba(31,44,65,.96),rgba(22,32,49,.96));border:1px solid rgba(239,191,98,.18);box-shadow:0 20px 48px rgba(0,0,0,.24)}
.jld-vip .jld-status-icon{color:#16120c;background:linear-gradient(145deg,#f8dc9d,#d69a3a);box-shadow:0 12px 27px rgba(218,157,63,.22)}
.jld-vip.is-locked .jld-status-icon{color:#fff;background:linear-gradient(145deg,#a94b4b,#6f2b3c)}
.jld-vip .jld-status-kicker,.jld-vip .jld-panel-kicker{color:#c69a50}.jld-vip .jld-status-copy h2{color:#fff}.jld-vip .jld-status-copy p{color:rgba(244,241,232,.58)}
.jld-vip .jld-status-seal{color:#f1d292;background:rgba(239,191,98,.08);border:1px solid rgba(239,191,98,.2)}.jld-vip.is-locked .jld-status-seal{color:#e7a0a0;background:rgba(176,68,68,.12);border-color:rgba(209,90,90,.22)}
.jld-vip .jld-panel{background:linear-gradient(145deg,rgba(27,39,59,.98),rgba(19,29,45,.98));border:1px solid rgba(239,191,98,.12);box-shadow:0 18px 38px rgba(0,0,0,.2)}
.jld-vip .jld-panel-heading{border-bottom:1px solid rgba(239,191,98,.11)}.jld-vip .jld-panel-heading h2,.jld-vip .jld-panel-heading h3{color:#fff}.jld-vip .jld-panel-heading h2 i,.jld-vip .jld-panel-heading h3 i{color:#efbf62}
.jld-vip .jld-secure-badge{color:#ecd397;background:rgba(239,191,98,.075);border:1px solid rgba(239,191,98,.15)}
.jld-vip .jld-resource-doc{color:#e7e1d5}.jld-vip .jld-resource-details{color:#c9c2b6;background:rgba(255,255,255,.035);border:1px solid rgba(239,191,98,.1)}.jld-vip .jld-info-icon{color:#17130c;background:linear-gradient(145deg,#f6d78e,#d39536)}
.jld-vip .jld-hidden-info{background:rgba(8,13,22,.34);border:1px solid rgba(239,191,98,.13)}.jld-vip .jld-hidden-heading{color:#efd18e;background:rgba(239,191,98,.075);border-bottom:1px solid rgba(239,191,98,.1)}.jld-vip .jld-hidden-content{color:#cfc7b8}
.jld-vip .jld-login-notice{color:#e7d8b6;background:rgba(239,191,98,.07);border:1px solid rgba(239,191,98,.16)}
.jld-vip .jld-locked-illustration{color:#fff;background:linear-gradient(145deg,#9f4646,#63283b);box-shadow:0 15px 30px rgba(112,38,54,.26)}
.jld-vip .jld-locked-box p,.jld-vip .jld-help-panel p,.jld-vip .jld-steps small,.jld-vip .jld-notice-panel li{color:rgba(244,241,232,.57)}
.jld-vip .jld-steps li>span{color:#15120d;background:linear-gradient(145deg,#f5d587,#ca8b2d)}
.jld-vip .jld-help-icon{color:#fff;background:linear-gradient(145deg,#3198d3,#24619a);box-shadow:0 12px 24px rgba(30,94,153,.24)}
.jld-vip .jld-help-actions a{color:#17130c;background:linear-gradient(135deg,#f1cf86,#d39436)}.jld-vip .jld-help-actions a+a{color:#ecd49f;background:rgba(255,255,255,.035);border:1px solid rgba(239,191,98,.17)}
.jld-vip .jld-notice-panel{background:linear-gradient(145deg,#211d18,#2b241a);border-color:rgba(239,191,98,.2)}.jld-vip .jld-notice-panel h3{color:#f1d290}
.jld-vip .jld-page-content{color:#ddd5c7}
.jld-vip .muted-2-color{color:rgba(244,241,232,.58)!important}.jld-vip .muted-box{background:rgba(255,255,255,.04)!important;color:#d9d1c3!important}
...
/* VIP 资源中心版：亮色主题改为象牙金，深色主题继续使用原深海金色 */
body:not(.dark-theme) .jld-vip{background:linear-gradient(180deg,#f7f3e9,#f1ede4 48%,#f7f4ed);color:#2d302f}
body:not(.dark-theme) .jld-vip .jld-hero{background:radial-gradient(circle at 82% 18%,rgba(204,147,48,.14),transparent 28%),radial-gradient(circle at 15% 85%,rgba(56,111,176,.11),transparent 32%),linear-gradient(135deg,#fffdf7,#f6efdf 58%,#efe7d7)}
body:not(.dark-theme) .jld-vip .jld-decoration-one{border-color:rgba(190,128,31,.18);box-shadow:0 0 80px rgba(213,155,56,.08) inset}
body:not(.dark-theme) .jld-vip .jld-decoration-two{background:rgba(55,105,166,.08);box-shadow:0 0 70px rgba(60,115,178,.1)}
body:not(.dark-theme) .jld-vip .jld-breadcrumb,
body:not(.dark-theme) .jld-vip .jld-breadcrumb a{color:#7d725f}
body:not(.dark-theme) .jld-vip .jld-breadcrumb a:hover{color:#b77920}
body:not(.dark-theme) .jld-vip .jld-cover{border-color:rgba(180,121,31,.25);background:linear-gradient(145deg,#2e4059,#7a5526);box-shadow:0 25px 52px rgba(80,57,25,.2)}
body:not(.dark-theme) .jld-vip .jld-eyebrow{color:#b47720}
body:not(.dark-theme) .jld-vip .jld-hero-copy h1,
body:not(.dark-theme) .jld-vip .jld-status-copy h2,
body:not(.dark-theme) .jld-vip .jld-panel-heading h2,
body:not(.dark-theme) .jld-vip .jld-panel-heading h3,
body:not(.dark-theme) .jld-vip .jld-steps b,
body:not(.dark-theme) .jld-vip .jld-help-panel h3,
body:not(.dark-theme) .jld-vip .jld-locked-box h3{color:#272d36}
body:not(.dark-theme) .jld-vip .jld-hero-copy>p,
body:not(.dark-theme) .jld-vip .jld-status-copy p,
body:not(.dark-theme) .jld-vip .jld-locked-box p,
body:not(.dark-theme) .jld-vip .jld-help-panel p,
body:not(.dark-theme) .jld-vip .jld-steps small,
body:not(.dark-theme) .jld-vip .jld-notice-panel li{color:#756e61}
body:not(.dark-theme) .jld-vip .jld-meta-list span{color:#655c4e;background:rgba(255,255,255,.62);border-color:rgba(177,124,38,.16)}
body:not(.dark-theme) .jld-vip .jld-button-ghost{color:#78571f;background:rgba(255,255,255,.62);border-color:rgba(178,124,37,.26)}
body:not(.dark-theme) .jld-vip .jld-status-card{background:rgba(255,253,247,.94);border-color:rgba(183,128,40,.2);box-shadow:0 20px 42px rgba(94,68,30,.12)}
body:not(.dark-theme) .jld-vip .jld-status-kicker,
body:not(.dark-theme) .jld-vip .jld-panel-kicker{color:#aa7427}
body:not(.dark-theme) .jld-vip .jld-status-seal{color:#8a641f;background:#fff5dd;border-color:#ecd8ad}
body:not(.dark-theme) .jld-vip.is-locked .jld-status-seal{color:#a55252;background:#fff0ee;border-color:#f0d2ce}
body:not(.dark-theme) .jld-vip .jld-panel{background:rgba(255,253,248,.95);border-color:rgba(174,122,39,.17);box-shadow:0 18px 36px rgba(86,62,27,.09)}
body:not(.dark-theme) .jld-vip .jld-panel-heading{border-bottom-color:rgba(180,126,37,.15)}
body:not(.dark-theme) .jld-vip .jld-panel-heading h2 i,
body:not(.dark-theme) .jld-vip .jld-panel-heading h3 i{color:#bb7d24}
body:not(.dark-theme) .jld-vip .jld-secure-badge{color:#8a641f;background:#fff5dd;border-color:#ecd8ad}
body:not(.dark-theme) .jld-vip .jld-resource-doc,
body:not(.dark-theme) .jld-vip .jld-page-content{color:#41454c}
body:not(.dark-theme) .jld-vip .jld-resource-details{color:#645f56;background:#f8f2e7;border-color:#e9dcc5}
body:not(.dark-theme) .jld-vip .jld-hidden-info{background:#fbf7ef;border-color:#eadcc3}
body:not(.dark-theme) .jld-vip .jld-hidden-heading{color:#895f1f;background:#f5ead6;border-bottom-color:#e7d6b8}
body:not(.dark-theme) .jld-vip .jld-hidden-content{color:#605b52}
body:not(.dark-theme) .jld-vip .jld-login-notice{color:#705b35;background:#fff6e6;border-color:#ecd9b7}
body:not(.dark-theme) .jld-vip .jld-help-actions a+a{color:#725626;background:#f8f0df;border-color:#e7d4b1}
body:not(.dark-theme) .jld-vip .jld-notice-panel{background:linear-gradient(145deg,#fff7e7,#f2e5cd);border-color:#e5cfaa}
body:not(.dark-theme) .jld-vip .jld-notice-panel h3{color:#805b20}
body:not(.dark-theme) .jld-vip .muted-box{background:#f5efe4!important;color:#635e55!important}
body:not(.dark-theme) .jld-vip .muted-2-color{color:#797268!important}
        ...
        <div class="content-layout">
            ...
            <?php if ('not' !== $content_style) : ?>
                <article class="article page-article main-bg theme-box main-shadow jld-article">
                    <div id="jl-download-page" class="jld-page jld-vip <?php echo esc_attr($access_class); ?>">
