<?php
/**
 * Template name: Zibll-资源下载（简洁商务版）
 * Description: 九流网络定制独立下载页（真实动态数据、深色模式自适应、横竖封面智能适配） - 简洁商务版 v4.2.1
 *
 * 使用说明：
...
.jld-business{--biz-navy:#15243a;--biz-blue:#2463eb;--biz-green:#0f9f77;background:#f4f6f9}
.jld-business .jld-hero{background:#fff;border-bottom:1px solid #e8ecf1}
.jld-business .jld-decoration-one{width:350px;height:350px;right:-180px;top:-180px;background:rgba(36,99,235,.05)}
.jld-business .jld-decoration-two{width:220px;height:220px;left:-130px;bottom:-150px;background:rgba(15,159,119,.06)}
.jld-business .jld-breadcrumb,.jld-business .jld-breadcrumb a{color:#7a8798}.jld-business .jld-breadcrumb a:hover{color:#2463eb}
.jld-business .jld-cover{border:1px solid #dfe5ec;background:linear-gradient(145deg,#eaf0f7,#d9e3ef);box-shadow:0 18px 38px rgba(34,53,79,.14)}
.jld-business .jld-cover-label{color:#fff;background:#15243a}.jld-business .jld-cover-mark{color:#fff;background:rgba(21,36,58,.85)}
.jld-business .jld-eyebrow{color:#2463eb}.jld-business .jld-eyebrow span{background:#0f9f77}
.jld-business .jld-hero-copy h1{color:#142136}.jld-business .jld-hero-copy>p{color:#667487}
.jld-business .jld-meta-list span{color:#536174;background:#f5f7fa;border:1px solid #e4e9ef}
.jld-business .jld-button-primary{color:#fff;background:#2463eb;box-shadow:0 9px 20px rgba(36,99,235,.22)}
.jld-business .jld-button-ghost{color:#24344b;background:#fff;border-color:#d9e0e8}
.jld-business .jld-status-card{background:#fff;border:1px solid #e1e6ec;box-shadow:0 12px 27px rgba(32,48,69,.08)}
.jld-business .jld-status-icon{color:#fff;background:#0f9f77;box-shadow:0 8px 18px rgba(15,159,119,.2)}
.jld-business.is-locked .jld-status-icon{background:#e45d3e}
.jld-business .jld-status-kicker,.jld-business .jld-panel-kicker{color:#728197}.jld-business .jld-status-copy h2{color:#18263a}.jld-business .jld-status-copy p{color:#738094}
.jld-business .jld-status-seal{color:#12745a;background:#eaf8f3;border:1px solid #d8f0e7}.jld-business.is-locked .jld-status-seal{color:#a34c35;background:#fff2ed;border-color:#ffe1d7}
.jld-business .jld-panel{background:#fff;border:1px solid #e2e7ed;box-shadow:0 8px 24px rgba(31,47,67,.055)}
.jld-business .jld-panel-heading{border-bottom:1px solid #e9edf2}.jld-business .jld-panel-heading h2,.jld-business .jld-panel-heading h3{color:#18263a}.jld-business .jld-panel-heading h2 i,.jld-business .jld-panel-heading h3 i{color:#2463eb}
.jld-business .jld-secure-badge{color:#16664f;background:#edf8f4;border:1px solid #d8eee7}
.jld-business .jld-resource-details{color:#5e6d80;background:#f7f9fb;border:1px solid #e6ebf0}.jld-business .jld-info-icon{color:#fff;background:#2463eb}
.jld-business .jld-hidden-info{background:#fafbfc;border:1px solid #e2e7ed}.jld-business .jld-hidden-heading{color:#24364f;background:#f1f4f7;border-bottom:1px solid #e2e7ed}.jld-business .jld-hidden-content{color:#59687a}
.jld-business .jld-login-notice{color:#214e78;background:#eef6ff;border:1px solid #d8eaff}
.jld-business .jld-locked-illustration{color:#fff;background:#e45d3e;box-shadow:0 12px 24px rgba(228,93,62,.18)}
.jld-business .jld-locked-box p,.jld-business .jld-help-panel p,.jld-business .jld-steps small,.jld-business .jld-notice-panel li{color:#738094}
.jld-business .jld-steps li>span{color:#fff;background:#15243a}
.jld-business .jld-help-icon{color:#fff;background:#269bd8;box-shadow:0 10px 20px rgba(38,155,216,.18)}
.jld-business .jld-help-actions a{color:#fff;background:#2463eb}.jld-business .jld-help-actions a+a{color:#24364f;background:#f2f5f8;border:1px solid #e1e6ec}
.jld-business .jld-notice-panel{border-left:4px solid #0f9f77}.jld-business .jld-notice-panel h3 i{color:#0f9f77}
...
/* 简洁商务版：深色主题配色 */
.dark-theme .jld-business{background:#292a2d;color:#e5eef7}
.dark-theme .jld-business .jld-hero{background:#303236;border-bottom-color:#414348}
.dark-theme .jld-business .jld-decoration-one{background:rgba(63,116,235,.09)}
.dark-theme .jld-business .jld-decoration-two{background:rgba(24,176,132,.08)}
.dark-theme .jld-business .jld-breadcrumb,
.dark-theme .jld-business .jld-breadcrumb a{color:#a7b0bd}
.dark-theme .jld-business .jld-breadcrumb a:hover{color:#73a0ff}
.dark-theme .jld-business .jld-cover{border-color:#4a4e56;background:linear-gradient(145deg,#313846,#232a34);box-shadow:0 18px 38px rgba(0,0,0,.25)}
.dark-theme .jld-business .jld-hero-copy h1,
.dark-theme .jld-business .jld-status-copy h2,
.dark-theme .jld-business .jld-panel-heading h2,
.dark-theme .jld-business .jld-panel-heading h3,
.dark-theme .jld-business .jld-steps b,
.dark-theme .jld-business .jld-help-panel h3,
.dark-theme .jld-business .jld-locked-box h3{color:#f0f5fb}
.dark-theme .jld-business .jld-hero-copy>p,
.dark-theme .jld-business .jld-status-copy p,
.dark-theme .jld-business .jld-locked-box p,
.dark-theme .jld-business .jld-help-panel p,
.dark-theme .jld-business .jld-steps small,
.dark-theme .jld-business .jld-notice-panel li{color:#aab3c0}
.dark-theme .jld-business .jld-meta-list span{color:#c6cfdb;background:#373a40;border-color:#484c53}
.dark-theme .jld-business .jld-button-ghost{color:#dce5ef;background:#35373b;border-color:#50535a}
.dark-theme .jld-business .jld-status-card{background:#333539;border-color:#45484e;box-shadow:0 12px 27px rgba(0,0,0,.2)}
.dark-theme .jld-business .jld-status-kicker,
.dark-theme .jld-business .jld-panel-kicker{color:#9aa7b9}
.dark-theme .jld-business .jld-status-seal{color:#77dbc0;background:rgba(15,159,119,.12);border-color:rgba(67,194,158,.18)}
.dark-theme .jld-business.is-locked .jld-status-seal{color:#f1a28e;background:rgba(228,93,62,.11);border-color:rgba(235,121,94,.18)}
.dark-theme .jld-business .jld-panel{background:#333539;border-color:#45484e;box-shadow:0 8px 24px rgba(0,0,0,.17)}
.dark-theme .jld-business .jld-panel-heading{border-bottom-color:#474a50}
.dark-theme .jld-business .jld-secure-badge{color:#79d6bb;background:rgba(15,159,119,.1);border-color:rgba(70,190,154,.16)}
.dark-theme .jld-business .jld-resource-doc,
.dark-theme .jld-business .jld-page-content{color:#d8e0ea}
.dark-theme .jld-business .jld-resource-details{color:#bdc6d1;background:#2d2f33;border-color:#45484e}
.dark-theme .jld-business .jld-hidden-info{background:#2d2f33;border-color:#45484e}
.dark-theme .jld-business .jld-hidden-heading{color:#d7e0eb;background:#393b40;border-bottom-color:#4a4d53}
.dark-theme .jld-business .jld-hidden-content{color:#c2cbd6}
.dark-theme .jld-business .jld-login-notice{color:#b9d8f6;background:rgba(36,99,235,.1);border-color:rgba(79,132,241,.18)}
.dark-theme .jld-business .jld-help-actions a+a{color:#d8e0ea;background:#3a3c41;border-color:#4c4f56}
.dark-theme .jld-business .jld-notice-panel{background:#303336;border-left-color:#21b486}
.dark-theme .jld-business .muted-box{background:#2d2f33!important;color:#c4ccd6!important}
.dark-theme .jld-business .muted-2-color{color:#aab3bf!important}
        ...
        <div class="content-layout">
            ...
            <?php if ('not' !== $content_style) : ?>
                <article class="article page-article main-bg theme-box main-shadow jld-article">
                    <div id="jl-download-page" class="jld-page jld-business <?php echo esc_attr($access_class); ?>">
